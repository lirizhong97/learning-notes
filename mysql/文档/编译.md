...
```
cmake -DBUILD_CONFIG=mysql_release -DDOWNLOAD_BOOST=1 -DWITH_BOOST=../boost -DWITH_DEBUG=1 -DWITH_INNODB_EXTRA_DEBUG=ON -DENABLE_GPROF=ON ..
```
...
log-error=/tmp/mysql/mysql-data/error.log
symbolic-links=0
